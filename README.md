...
> [!TIP]
> The screenshot above is **real output** — every sticker was generated by `icon-forge` itself through the canonical [`dev-pack`](#examples) preset. The 12 individual PNGs live under [`examples/slack-stickers/dev-pack/`](examples/slack-stickers/dev-pack/).
...
|---|---|---|
| [`slack-stickers`](profiles/bundles/slack-stickers.json) | 1–12 transparent emoji-sized PNGs + Slack import README | Custom Slack emoji packs |
| [`app-icons`](profiles/bundles/app-icons.json) | One design rendered at 8 platform sizes (16–1024) + usage README | App icons, favicons |
| [`app-icon-set`](profiles/bundles/app-icon-set.json) | 1–12 distinct designs × 8 sizes each + family README | Multi-target icon families (main + share-ext + watch + ...) |
...
<details>
<summary><kbd><strong>Full command sequence — prepare → status → record → extract → finalize</strong></kbd></summary>
...
[back-to-top-shield]: https://img.shields.io/badge/-BACK_TO_TOP-151515?style=flat-square

[github-license-link]: https://github.com/RWitzner/codex-icon-forge/blob/main/LICENSE
[github-license-shield]: https://img.shields.io/github/license/RWitzner/codex-icon-forge?style=flat-square&labelColor=black&color=blue

[python-link]: https://www.python.org
[python-shield]: https://img.shields.io/badge/python-3.10%2B-blue?style=flat-square&labelColor=black&logo=python&logoColor=white

[codex-shield]: https://img.shields.io/badge/codex-skill-369eff?style=flat-square&labelColor=black

[pr-welcome-link]: https://github.com/RWitzner/codex-icon-forge/pulls
[pr-welcome-shield]: https://img.shields.io/badge/PRs-welcome-brightgreen?style=flat-square&labelColor=black

[github-stars-link]: https://github.com/RWitzner/codex-icon-forge/stargazers
[github-stars-shield]: https://img.shields.io/github/stars/RWitzner/codex-icon-forge?style=flat-square&labelColor=black&color=ffcb47&logo=github

[github-forks-link]: https://github.com/RWitzner/codex-icon-forge/network/members
[github-forks-shield]: https://img.shields.io/github/forks/RWitzner/codex-icon-forge?style=flat-square&labelColor=black&color=8ae8ff&logo=github

[github-contributors-link]: https://github.com/RWitzner/codex-icon-forge/graphs/contributors
[github-contributors-shield]: https://img.shields.io/github/contributors/RWitzner/codex-icon-forge?style=flat-square&labelColor=black&color=c4f042

[github-issues-link]: https://github.com/RWitzner/codex-icon-forge/issues
[github-issues-shield]: https://img.shields.io/github/issues/RWitzner/codex-icon-forge?style=flat-square&labelColor=black&color=ff80eb

[github-last-commit-link]: https://github.com/RWitzner/codex-icon-forge/commits/main
[github-last-commit-shield]: https://img.shields.io/github/last-commit/RWitzner/codex-icon-forge?style=flat-square&labelColor=black&color=ff5722
